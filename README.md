...
full-featured backend for Yjs. pluv.io can either be self-hosted on Cloudflare
Workers and Node.js runtimes, or be used on its fully-managed WebSocket
infrastructure. Offers a typesafe API with authentication, webhooks, rooms,
and more.
  </dd>
